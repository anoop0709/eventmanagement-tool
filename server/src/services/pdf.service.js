...
const renderComplexValue = (value, key = '') => {
  ...
  if (Array.isArray(value)) {
    ...
    if (hasObjects) {
      ...
      return value
        .map((v) => (typeof v === 'string' ? formatStringValue(v) : String(v)))
        .join(', ');
    }
  }
...
export const generateEventPDF = async (eventData) => {
  try {
    ...
    return new Promise((resolve, reject) => {
      ...
      doc.rect(0, headerHeight, doc.page.width, 3).fill(colors.primary);
      ...
      doc.rect(40, cardStartY, doc.page.width - 80, titleHeight).fill(colors.secondary);
      ...
      clientInfo.forEach(([label, value], index) => {
        ...
        doc.rect(40, rowY, doc.page.width - 80, rowHeight).fill(colors.white);
      ...
      doc.rect(40, eventCardStartY, doc.page.width - 80, titleHeight).fill(colors.secondary);
      ...
      const selectedServices = Object.keys(services).filter(
        (key) => services[key] && typeof services[key] === 'object'
      );
      ...
      if (selectedServices.length > 0) {
        ...
        doc
          ...
          .fillColor(colors.white)
          .font('Helvetica-Bold')
          .text('SERVICES', 50, servicesHeaderY + 10, {
            width: doc.page.width - 100,
            characterSpacing: 1,
          });
        ...
        selectedServices.forEach((serviceKey, serviceIndex) => {
          ...
          doc
            ...
            .fillColor(colors.dark)
            .font('Helvetica-Bold')
            .text(formatLabel(serviceKey).toUpperCase(), 50, serviceHeaderY + 12, {
              width: doc.page.width - 100,
              characterSpacing: 0.5,
            });
            ...
            entries.forEach(([fieldKey, fieldValue]) => {
              ...
              if (processedValue && typeof processedValue === 'object' && processedValue._isArray) {
                ...
                doc
                  ...
                  .fillColor(colors.medium)
                  .font('Helvetica-Bold')
                  .text(formatLabel(fieldKey), 56, arrayLabelY + 8, {
                    ...
                    if (
                      ...
                      try {
                        ...
                        if (imageCache[imageSrc]) {
                          try {
                            ...
                            doc
                              ...
                              .text(`[Image format issue]`, 76, doc.y, {
                          ...
                          if (fs.existsSync(localPath)) {
                            ...
                            doc
                              ...
                              .fillColor(colors.light)
                              .font('Helvetica-Oblique')
                              .text(`[Image not found: ${path.basename(imageSrc)}]`, 76, doc.y, {
                                width: doc.page.width - 136,
                                align: 'center',
                              });
                            doc.y += 15;
                          ...
                          doc
                            ...
                            .fillColor(colors.light)
                            .font('Helvetica-Oblique')
                            .text(`[Image unavailable]`, 76, doc.y, {
                              width: doc.page.width - 136,
                              align: 'center',
                            });
                          doc.y += 15;
                        ...
                        doc
                          ...
                          .fillColor(colors.light)
                          .font('Helvetica-Oblique')
                          .text(`[Image could not be displayed]`, 76, doc.y, {
                            width: doc.page.width - 136,
                            align: 'center',
                          });
                        doc.y += 15;
                      ...
                      Object.entries(item).forEach(([itemKey, itemValue], idx) => {
                        ...
                        doc
                          ...
                          .fillColor(colors.medium)
                          .font('Helvetica-Bold')
                          .text(formatLabel(itemKey), 76, itemRowY + 7, {
                            width: 160,
                            continued: false,
                          });
                        ...
                        doc
                          ...
                          .fillColor(colors.dark)
                          .font('Helvetica')
                          .text(displayVal, 246, itemRowY + 7, {
                            width: doc.page.width - 286,
                            continued: false,
                          });
              ...
              // Handle nested objects (like foodServingInVenue)
                ...
                doc
                  ...
                  .fillColor(colors.medium)
                  .font('Helvetica-Bold')
                  .text(formatLabel(fieldKey), 56, objLabelY + 8, {
                    width: doc.page.width - 96,
                    continued: false,
                  });
                ...
                Object.entries(processedValue.data).forEach(([nestedKey, nestedValue]) => {
                  if (nestedKey === '_id' || nestedValue === null || nestedValue === undefined)
                    return;
                  ...
                  if (
                    ...
                    doc
                      ...
                      .fillColor(colors.medium)
                      .font('Helvetica-Bold')
                      .text(formatLabel(nestedKey), 76, nestedArrLabelY + 7, {
                        width: doc.page.width - 136,
                        continued: false,
                      });
                      ...
                      if (typeof nestedItem === 'object' && nestedItem !== null) {
                        Object.entries(nestedItem).forEach(([nKey, nValue]) => {
                          ...
                          doc
                            ...
                            .fillColor(colors.medium)
                            .font('Helvetica-Bold')
                            .text(formatLabel(nKey), 86, nRowY + 6, {
                              width: 150,
                              continued: false,
                            });
                          ...
                          if (
                            ...
                            (typeof nValue === 'string' &&
                              (nValue.startsWith('http') || nValue.startsWith('/')))
                          ) {
                            nDisplayVal = nValue; // Show full URL for images
                          } else if (
                            typeof nValue === 'string' &&
                            /date|time|timing|check|pickup|drop/i.test(nKey) &&
                            nValue.includes('T')
                          ) {
                            // Format date fields
                            const dateValue = new Date(nValue);
                            nDisplayVal = !isNaN(dateValue.getTime())
                              ? formatDate(nValue)
                              : formatStringValue(nValue);
                          } else {
                            nDisplayVal =
                              typeof nValue === 'string'
                                ? formatStringValue(nValue)
                    ...
                    doc
                      ...
                      .fillColor(colors.medium)
                      .font('Helvetica-Bold')
                      .text(formatLabel(nestedKey), 76, nestedRowY + 7, {
                        width: 160,
                        continued: false,
                      });

                    const nestedDisplayVal =
                      typeof nestedValue === 'string'
                        ? formatStringValue(nestedValue)
                    ...
                    doc
                      ...
                      .fillColor(colors.dark)
                      .font('Helvetica')
                      .text(nestedDisplayVal, 246, nestedRowY + 7, {
                        width: doc.page.width - 286,
                        continued: false,
                      });
              ...
              // Handle simple fields (strings, numbers, booleans)
                ...
                const displayValue =
                  fieldKey === 'budget' ? formatBudgetValue(fieldValue) : String(processedValue);
      ...
      const selectedAddOns = Object.keys(addOns).filter(
        (key) => addOns[key] && typeof addOns[key] === 'object'
      );
      ...
      if (selectedAddOns.length > 0) {
        ...
        doc
          ...
          .fillColor(colors.white)
          .font('Helvetica-Bold')
          .text('ADD-ONS', 50, addonsHeaderY + 10, {
            width: doc.page.width - 100,
            characterSpacing: 1,
          });
        ...
        selectedAddOns.forEach((addonKey, addonIndex) => {
          ...
          doc
            ...
            .fillColor(colors.dark)
            .font('Helvetica-Bold')
            .text(formatLabel(addonKey).toUpperCase(), 50, addonHeaderY + 12, {
              width: doc.page.width - 100,
              characterSpacing: 0.5,
            });
          ...
          if (addonDetails && typeof addonDetails === 'object') {
            Object.entries(addonDetails).forEach(([fieldKey, fieldValue]) => {
              ...
              const simpleDisplayValue =
                fieldKey === 'budget'
                  ? formatBudgetValue(fieldValue)
                  : typeof fieldValue === 'boolean'
                    ? fieldValue
                      ? 'Yes'
                      : 'No'
                    : typeof fieldValue === 'string'
                      ? formatStringValue(fieldValue)
                      : String(fieldValue);
              doc
                .fontSize(10)
                .fillColor(colors.dark)
                .font('Helvetica')
                .text(simpleDisplayValue, 236, rowY + 7, {
                  width: doc.page.width - 276,
                  continued: false,
                });
      ...
      if (budgetData.grandTotal > 0) {
        ...
        doc.rect(40, totalY, doc.page.width - 80, totalCardHeight).fill(colors.primary);
